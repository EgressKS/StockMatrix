...
// Fallback order: expo-constants -> environment variables -> defaults
export const API_BASE_URL = extra.apiBaseUrl || process.env.API_BASE_URL || 'https://stock-matrix-server.vercel.app/api';
